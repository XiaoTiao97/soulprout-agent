...
description: >
  ...
  Use when creating structured task lists with user stories, specifying features with
  acceptance criteria, or planning feature implementation for AI agents or human developers.
