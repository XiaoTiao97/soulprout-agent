  ...
  var MESSAGES = {
    'zh-CN': {
      ...
      index: {
        ...
        rokidName: 'Rokid AI 眼镜',
        rokidReady: '已生成 API Key · {id}',
        rokidIdle: '未生成，点击进入配置眼镜接入',
        fillEmail: '请填写邮箱',
        sending: '发送中…',
      ...
      weixin: {
        ...
        title: '微信',
        desc: '通过微信接入 Soulprout，扫码登录后 Gateway 将自动建立长轮询连接。',
        statusSection: '连接状态',
        statusLabel: '连接状态',
        accountId: '账号 ID',
        ...
        success: '✓ 登录成功！正在连接…',
        connectedOk: '✓ 已连接',
        connectFailed: '✗ 登录成功但连接失败，请点击「重新连接」或重新扫码',
        failed: '✗ 错误：',
        unknown: '未知',
      },
      feishu: {
      ...
      rokid: {
        ...
        title: 'Rokid AI 眼镜',
        desc: '在本地生成 API Key 并自动上传到 Soulprout 主站。Rokid 云调用主站 SSE（www.soulprout.com），按 Key 路由到你的 Soul。',
        guideSection: '如何配置 Rokid 眼镜',
        guide1: '首先打开 Rokid 平台首页：<a href="https://rizon.rokid.com/space/home" target="_blank" rel="noopener">https://rizon.rokid.com/space/home</a>',
        ...
        sseUrl: '自定义智能体 URL',
        sseUrlHint: '固定为主站地址，请直接填入 Rokid 平台。',
        ensureKey: '生成 / 同步 API Key',
        regenKey: '重新生成 Key',
        regenWarn: '重新生成后，Rokid 平台的第三方智能体必须重新配置新的 AK，否则眼镜将无法调用。',
        copy: '复制',
        ready: '已就绪',
        notReady: '未生成',
        loadFailed: '加载失败：',
        remoteWarn: '主站同步失败（已显示本地缓存）：',
        hostMismatch: '当前登录的不是 www.soulprout.com。Rokid SSE 指向该域名，请退出后改用云服务再生成/同步 Key，否则眼镜可能鉴权失败。',
        ensuring: '正在生成并上传…',
        ...
        regenFailed: '重新生成失败：',
        regenConfirm: '重新生成后，Rokid 平台的第三方智能体需要重新配置新的 AK，否则将无法调用。确定继续？',
        copied: '已复制到剪贴板',
        copyEmpty: '没有可复制的内容',
        copyFailed: '复制失败',
      },
    ...
    en: {
      ...
      index: {
        ...
        loginDesc: 'Connect across devices with a new experience.',
        ...
        rokidName: 'Rokid AI Glasses',
        rokidReady: 'API Key ready · {id}',
        rokidIdle: 'Not set up — tap to configure glasses',
      ...
      weixin: {
        ...
        title: 'WeChat',
        desc: 'Connect Soulprout via WeChat. After scanning, Gateway keeps a long-poll connection.',
        ...
        connectFailed: '✗ Signed in but connection failed — tap Reconnect or scan again',
        failed: '✗ Error: ',
        unknown: 'unknown',
      },
      feishu: {
      ...
      rokid: {
        pageTag: 'Rokid AI Glasses',
        eyebrow: 'Gateway · Glasses',
        title: 'Rokid AI Glasses',
        desc: 'Generate an API Key locally and upload it to the Soulprout cloud. Rokid calls the cloud SSE (www.soulprout.com) and routes to your Soul by Key.',
        guideSection: 'How to configure Rokid glasses',
        guide1: 'Open the Rokid home page: <a href="https://rizon.rokid.com/space/home" target="_blank" rel="noopener">https://rizon.rokid.com/space/home</a>',
        ...
        sseUrlHint: 'Fixed cloud URL — paste into Rokid as-is.',
        ensureKey: 'Generate / sync API Key',
        regenKey: 'Regenerate Key',
        regenWarn: 'After regenerating, you must reconfigure the new AK in Rokid third-party agent settings, or glasses calls will fail.',
        copy: 'Copy',
        ready: 'Ready',
        notReady: 'Not generated',
        loadFailed: 'Failed to load: ',
        remoteWarn: 'Cloud sync failed (showing local cache): ',
        hostMismatch: 'You are not logged into www.soulprout.com. Rokid SSE points there — sign out and use Cloud before generating/syncing the Key, or glasses auth may fail.',
        ...
        regenConfirm: 'Regenerating requires updating the AK in Rokid third-party agent config, or calls will fail. Continue?',
        copied: 'Copied',
